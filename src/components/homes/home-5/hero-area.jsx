...
import shape_4 from "../../../../public/assets/img/lysa/home/home-banner.webp";
              ...
              <div className="tp-hero-five-section-wrap">
                <div className="tp-hero-five-section-box z-index">
                  <h3 className="tp-hero-title-5 hero-text-anim-2">
                    ...
                    <i>
                      <i className="child-2">
                        <span className="child-1 p-relative p-1">
                          {" "}
                          better
                          <LineShapTwo />
                        </span>
                    ...
                    <i>
                      <i className="child-2">
                        <span className="child-2">IT Solutions</span> <br />
                      </i>
                    </i>
                  ...
                  <p
                    ...
                    data-wow-delay=".5s"
                  >
                    We put a strong emphasis on developing IT solutions that
                    meet the needs of today. <br /> Our focus is also on
                    preparing our clients for the challenges of tomorrow.
                  </p>
                </div>
                <div
