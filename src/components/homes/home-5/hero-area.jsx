                           ...
                           <div className="tp-hero-five-section-wrap">
                              <div className="tp-hero-five-section-box z-index">
                                 <h3 className="tp-hero-title-5 hero-text-anim-2">
                                    <i><i className="child-2">Creating a <br /></i></i>
                                    <i>
                                       <i className="child-2">
                                          <span className="child-1 p-relative p-1"> better 
                                          <LineShapTwo />  
                                          </span>  
                                          <br /> 
                                       </i>
                                    </i>
                                    <i><i className="child-2"><span className="child-2">IT Solutions</span> <br /></i></i>
                                    {/* <i><i className="child-2">Software</i></i> */}
                                 </h3>
                                 <p className="wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">We put a strong emphasis on developing IT solutions that meet the needs of today. <br /> Our focus is also on preparing our clients for the challenges of tomorrow.</p>
                              </div>
