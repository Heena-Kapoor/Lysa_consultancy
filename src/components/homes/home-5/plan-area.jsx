...
const accordion_data = [
    {
        ...
        answer: <>To simplify IT for our clients, replacing the burden of high-touch IT services with prudently designed and managed IT solutions that include consulting, design, deployment, and live support.</>,
    ...
    },
    {
        id: 2,
        question: "Our Vision",
        answer: <>At LYSA, our vision is to be the most recognized and credible IT solution provider. We have resolutely adhered to three fundamental principles ever since our establishment: our people, expertise, and support.</>,
...
const PlanArea = () => {
    return (
        <>
            <div onContextMenu={e => e.preventDefault()} className="tp-plan-area tp-plan-1-space fix pb-50">
