...
const company_content ={
    ...
    title: <>Ready to accelerate your access to the Cloud?</>,
    info_1: <>Explore our latest and greatest managed cloud database resources and success stories to learn more about how LYSA CONSULTANCY can assist you in unlocking the full power of the cloud-managed database.</>,
}
